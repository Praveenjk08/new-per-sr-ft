<template>
    <section class="py-6 px-4 sm:px-6 lg:px-10 bg-[#FAF0E6] md:mx-10 my-6  rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-4 text-center hover:-translate-y-2 transition duration-300"
                ...
                <h3 class="text-2xl font-semibold text-[#2f2f68] mb-5">
                    Real Estate Consultation
                </h3>

                <p class="text-gray-600 leading-9 text-lg">
                    Get personalized real estate advice from our experts for
            ...
            <div class="bg-white rounded-3xl shadow-lg p-10 text-center hover:-translate-y-2 transition duration-300"
                ...
                <p class="text-gray-600 leading-9 text-lg">
                    Secure the best home loan solutions with easy documentation,
            ...
            <div @click="$router.push('/interior')"
                ...
                <p class="text-gray-600 leading-9 text-lg">
                    Transform your home with elegant, modern, and functional
            ...
            <div @click="$router.push('/legal')"
                ...
                <p class="text-gray-600 leading-9 text-lg">
                    Handle legal documentation, verification, and registration
