...
<Swiper
  v-if="project.carousel_images?.length"
  ...
  class="h-[250px] sm:h-[350px] md:h-[500px] lg:h-screen"
>
  ...
  >
    ...
    <div
      class="relative h-[250px] sm:h-[350px] md:h-[500px] lg:h-screen"
    >
...
<div
  class="bg-[#0B1560] rounded-[35px] overflow-hidden shadow-xl mx-6"
>

  <div
    class="h-2 bg-gradient-to-r from-yellow-400 to-orange-500"
  ></div>

  <div class="p-4 text-white">

    <p
      class="uppercase tracking-[5px] text-sm text-yellow-300"
    >
      Project Overview
    </p>

    <h2
      class="text-4xl md:text-5xl font-bold mt-4"
    >
      {{ project.project_name }}
    </h2>

    <div
      class="flex flex-wrap gap-6 mt-8 text-white/90"
    >
...
<section class="bg-[#f5f7fb] pb-10">
  ...
  <div class="max-w-7xl mx-auto px-6">
    ...
    >
      ...
      <h3
        class="text-3xl font-bold text-[#0B1560] mt-4 mb-8"
      >
        Description
      </h3>

      <div
        class="text-gray-700 leading-9"
        v-html="
          showFullDescription
            ? project.description
            : shortDescription
      ...
      <button
        v-if="project.description?.length > 500"
...
<section class="bg-[#f5f7fb] py-5">
  ...
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div
      ...
      class="bg-white rounded-[30px] p-6 md:p-8 shadow-xl"
    >
      ...
      >
        ...
        <div
          v-for="(item,index) in project.gallery_images.slice(0,8)"
          :key="index"
...
<section
  v-if="project.per_square_feet_gallery?.length"
  class="bg-white py-5"
>
  ...
  <div class="max-w-7xl mx-auto px-2">
    ...
    <div class="text-center mb-10">
      ...
      <p
        class="text-gray-500 mt-6 max-w-3xl mx-auto"
      >
...
>
  ...
  <Swiper
    :modules="[Navigation, Pagination, Autoplay]"
    :slides-per-view="1"
    :loop="project.per_square_feet_gallery.length > 1"
    :navigation="true"
    :pagination="{ clickable: true }"
    :autoplay="{
      delay: 3000,
  ...
  >
    ...
    >
      ...
      <img
        :src="item.image"
        :alt="item.alt_text"
        class="w-full h-[400px] object-cover bg-[#f8f9fc] p-2"
      />
...
<section class="bg-[#f5f7fb] py-10">
  ...
  <div class="max-w-7xl mx-auto px-6">
    ...
    >
      ...
      <div
        class="grid lg:grid-cols-12 gap-0"
      >
        ...
        >
          ...
          <p
            class="uppercase tracking-[5px] text-sm text-blue-200"
          >
            Developer Profile
          </p>
        ...
        >
          ...
          <h3
            class="text-3xl font-bold text-[#0B1560] mb-6"
          >
            {{ project.project_by_builder }}
          </h3>

          <p
            class="text-gray-600 leading-9 text-lg"
          >
          ...
          <div
            class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-10"
          >

            <div
              class="bg-[#f8f9fc] rounded-2xl p-6 text-center"
            >

              <h4
                class="text-3xl font-bold text-[#0B1560]"
              >
                20+
              </h4>
