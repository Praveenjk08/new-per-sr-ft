<template>
  ...
  <section class="px-4 sm:px-6 lg:px-10 my-8">
    ...
    >
      ...
      <!-- Banner Image -->
      <img
        src="/files/propertymanagementbanner.png"
  ...
  <section class="py-16 px-4 sm:px-6 lg:px-10">
    ...
    >
      ...
      <div>
        ...
        <div class="space-y-6">
          ...
          <p class="text-gray-600 text-base sm:text-lg leading-8">
            Our Property Management Services are designed to help
            property owners efficiently manage residential and
            commercial properties with complete peace of mind.
          </p>

          <p class="text-gray-600 text-base sm:text-lg leading-8">
            From tenant management and rental collection to regular
            maintenance and property inspections, our experienced
            team handles every aspect of property supervision
            professionally.
          </p>

          <p class="text-gray-600 text-base sm:text-lg leading-8">
            We focus on maintaining property value, ensuring tenant
            satisfaction, and delivering hassle-free management
      ...
      <div>
        ...
        <img
          src="/files/propertymanagementabout.png"
      ...
      >
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-base">
            Efficient handling of tenant onboarding, communication,
            and support for smooth property operations.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-base">
            Timely rent collection and financial management with
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-base">
            Regular inspections and maintenance services to keep
            your property in excellent condition.
          </p>
        </div>
      ...
      >
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Dedicated experts managing your property efficiently.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Quick response and regular maintenance support services.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Ensuring comfortable and smooth tenant experiences.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Complete end-to-end property management solutions.
          </p>
        </div>
