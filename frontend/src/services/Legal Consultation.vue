<template>
  ...
  <section class=" mb-0">
    ...
    <div class="relative w-full h-auto sm:h-[450px]  md:h-[450px] lg:h-[450px] overflow-hidden">
      ...
      <!-- Banner Image -->
      <img :src="getFileUrl('legalbanner.png')" alt="Legal Consultation Services"
      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 class="p-4 bg-white/25 text-black rounded-2xl text-3xl sm:text-5xl lg:text-4xl font-bold leading-tight">
  ...
  <section class="py-8 px-4 sm:px-6 lg:px-10">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
      ...
      <div>
        ...
        <div class="space-y-6">
          ...
          <p class="text-gray-600 text-base sm:text-lg leading-8">
            Our Legal Consultation Services help clients handle all
            legal aspects related to real estate transactions with
            confidence and peace of mind. We ensure proper verification,
            documentation, and legal compliance for every property.
          </p>

          <p class="text-gray-600 text-base sm:text-lg leading-8">
            From property verification and agreement drafting to
            registration assistance and legal approvals, our legal
            experts provide complete support throughout the process.
          </p>

          <p class="text-gray-600 text-base sm:text-lg leading-8">
            We focus on protecting our clients from legal risks,
            disputes, and documentation issues while ensuring a
            smooth and transparent property transaction experience.
          </p>
      ...
      <div>
        ...
        <img :src="getFileUrl('legalabout.png')" alt="Legal Consultation"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl p-8 shadow-lg hover:-translate-y-2 transition duration-300">
          ...
          <p class="text-gray-600 leading-8 text-base">
            Verify ownership documents, approvals, and property
            legality before making any investment decision.
          </p>
        </div>
        ...
        <div class="bg-white rounded-xl p-8 shadow-lg hover:-translate-y-2 transition duration-300">
          ...
          <p class="text-gray-600 leading-8 text-base">
            Professional assistance in preparing sale agreements,
            contracts, and legal property documents.
          </p>
        </div>
        ...
        <div class="bg-white rounded-xl p-8 shadow-lg hover:-translate-y-2 transition duration-300">
          ...
          <p class="text-gray-600 leading-8 text-base">
            Complete support for property registration procedures,
            approvals, and government formalities.
          </p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Skilled legal professionals with real estate expertise.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Clear and honest legal consultation at every stage.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Minimize legal risks and avoid future disputes.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            End-to-end assistance for all legal paperwork and approvals.
          </p>
        </div>
