<template>
  ...
  <section class="bg-[#f8f8f8] py-8 px-4 sm:px-6 lg:px-10">
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-7">
        ...
        <h2 class="text-2xl sm:text-[15px] lg:text-[15px] font-semibold text-[#2f2f68] mt-3">
          What We Offer
        </h2>
  ...
  <section class="pt-8 pb-16 px-4 sm:px-6 lg:px-10">
    ...
    <div class="max-w-6xl mx-auto text-center">
      ...
      <h2 class="text-2xl sm:text-[15px] lg:text-[15px] font-semibold text-[#2f2f68] mb-6">
...
>
  ...
  <section class="relative w-full bg-[#0B1560] py-16">
    ...
    <div class="text-center px-5">
      ...
      <h1 class="text-white text-4xl sm:text-4xlfont-bold">
        Ready To Build Your Dream Project?
      </h1>
