<template>
  ...
  <section class="   mb-0">
    ...
    >
      ...
      <!-- Banner Image -->
      <img
        src="/files/interiordesignbanner.png"
    ...
    >
      ...
      <div>
        ...
        <div class="space-y-6">
          ...
          <p class="text-gray-600 text-base sm:text-[15px] leading-8">
            Our Interior Design Services are focused on creating
            stylish, comfortable, and functional spaces that reflect
            your personality and lifestyle.
          </p>

          <p class="text-gray-600 text-base sm:text-[15px] leading-8">
            From living rooms and bedrooms to office interiors and
            commercial spaces, we provide innovative design concepts,
            premium materials, and modern aesthetics tailored to your
            needs.
          </p>

          <p class="text-gray-600 text-base sm:text-[15px] leading-8">
            We combine creativity, functionality, and attention to
            detail to deliver interiors that enhance beauty, comfort,
      ...
      <div>
        ...
        <img
          src="/files/interiordesignabout.png"
          alt="Interior Design"
  ...
  <section class="bg-[#f8f8f8] py-8 px-4 sm:px-6 lg:px-10">
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-7">
        ...
        <p class="text-[#4b4b9b] font-semibold text-[18px]">
          Our Interior Services
        </p>

        <h2
          class="text-2xl sm:text-[15px] lg:text-[15px] font-semibold text-[#2f2f68] mt-3"
        >
          What We Offer
        </h2>
      ...
      >
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-[15px]">
            Elegant and personalized interior solutions for modern
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-[15px]">
            Professional office interiors designed to improve
            productivity, comfort, and workspace aesthetics.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 leading-8 text-[15px]">
            Smart space utilization and modern layouts to maximize
  ...
  <section class="pt-8 pb-16 px-4 sm:px-6 lg:px-10">
    ...
    <div class="max-w-6xl mx-auto text-center">
      ...
      <h2
        class="text-2xl sm:text-[15px] lg:text-[15px] font-semibold text-[#2f2f68] mb-6"
      >
      ...
      >
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Unique and modern interiors crafted with creativity.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            High-quality materials and elegant finishing for every space.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Interior concepts tailored to your style and preferences.
          </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-3xl p-8">
          ...
          <p class="text-gray-600 leading-8">
            Professional execution with timely completion and support.
          </p>
        </div>
    ...
    <!-- <section
  class="relative w-full bg-[#0B1560] pt-16 pb-8 mb-0 "
>
