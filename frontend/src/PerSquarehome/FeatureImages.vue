<template>
  <!-- Amenities Section -->
  <section class="py-2 px-5 lg:px-20 bg-[#FAF0E6]">
    ...
    <div class="text-center mb-14">
      ...
      <p class="text-gray-500 mt-4 text-base sm:text-lg">
        Experience luxury lifestyle with world-class facilities
      </p>
